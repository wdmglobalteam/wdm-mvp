        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
          <section className="p-8 rounded-2xl bg-gradient-to-b from-[#071233] to-[#081229] shadow-xl">
            ...
            <p className="text-sm text-gray-300 mb-6">
              Unlock all courses, mentorship channels, progress tracking and
              deeper access to WDM community features. Payment is handled by
              Paystack — secure and industry standard.
            </p>
